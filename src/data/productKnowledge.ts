...
export const getGenericDescription = (name: string, category: string): string => {
  ...
  return `**Uso:** Producto especializado para el catálogo general. \n**Recomendación:** El artículo "${name}" ha sido seleccionado por su comprobada eficiencia. Se recomienda leer la etiqueta completa y ajustar el uso según sus necesidades específicas. \n**Precauciones:** Almacenar en un lugar seco y fresco. Consulte a su asesor técnico para un plan de manejo integral.`;
};
